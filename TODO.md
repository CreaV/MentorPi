...
- [ ] **验收**：3×3m 闭合路径，直线漂移 < 5%。
      （2026-07-16 部分完成：0.7m 方形 CCW 圈,`scripts/acceptance_square.py`
      激光 ICP 真值:估计误差平移 76mm/2.7% ✅ yaw 3.55° ✅;CW 圈没电中断,
      待充电补测。注:rotate 原语 0.5 rad/s 下每 90° 过冲 ~3.5° 是执行误差,
      EKF 可见,属 motion_node 调参,不算里程计账。）
